...
public class ObjectGraphService {
   ...
   * injection, typically for {@link android.app.Activity} and {@link android.view.View} instances that must be
  ...
  /**
   * Returns the existing {@link MortarScope} scope for the given {@link android.app.Activity}, or
   ...
   * <p/>
   * It is expected that this method will be called from {@link android.app.Activity#onCreate}. Calling
