...
package co.moonmonkeylabs.flowmortarexampleapp.common.flow;
...
public class SimplePathContainer extends PathContainer {
  ...
  private void runAnimation(final ViewGroup container, final View from, final View to,
    ...
    Animator animator = createAnimatorScale(from, to, direction);
  ...
  private Animator createAnimatorScale(View from, View to, Flow.Direction direction) {
    AnimatorSet set = new AnimatorSet();

    set.play(ObjectAnimator.ofFloat(from, View.SCALE_X, 1, 0))
        .with(ObjectAnimator.ofFloat(from, View.SCALE_Y, 1, 0));
    set.play(ObjectAnimator.ofFloat(to, View.SCALE_X, 0, 1))
        .with(ObjectAnimator.ofFloat(to, View.SCALE_Y, 0, 1));

    return set;
  }

  private Animator createAnimatorSliding(View from, View to, Flow.Direction direction) {
